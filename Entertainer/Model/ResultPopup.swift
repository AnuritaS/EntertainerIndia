...
//  
//
//  Created by Anurita Srivastava on 15/02/18.

import Foundation
import ObjectMapper


class ResultPopup : NSObject, NSCoding, Mappable{
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        client = aDecoder.decodeObject(forKey: "client") as? ClientPopup
